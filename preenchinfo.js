...
Ambiente simples e muito acolhedor.`,
    imagemicone: "img/restaurantes/Bode do Nô/bodedono.png", 
...
Foco em culinária portuguesa com ambiente elegante.`,
    imagemicone: "img/restaurantes/Restaurante Leite/restauranteleite.png", 
...
Ambiente rústico e sofisticado, ideal para apreciadores de carne.`,
    imagemicone: "img/restaurantes/Casa da Parrilla/casadaparrilla.png", 
...
Cardápio variado com opções para todos os gostos, incluindo vegetarianos.`,
    imagemicone: "img/restaurantes/Geração Burguer/geracaoburguer.png", 
...
Massas artesanais e bom atendimento.`,
    imagemicone: "img/restaurantes/Magalhães Pizza/magalhaespizza.png", 
...
Destaque para a pizza de burrata e o tiramisù.`,
    imagemicone: "img/restaurantes/Lupi Pizzeria/lupipizzeria.png", 
...
if (dados) {
  ...
  console.error("Restaurante com ID '" + restauranteId + "' não foi encontrado.");
}